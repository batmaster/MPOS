...
public class InventoryTableRow extends TableRow {
	...
	public InventoryTableRow(Context context, ProductDescription productDescription, ProductQuantity productQuantity) {
		super(context);
		...
		rowProductId.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
		addView(rowProductId);
		
		rowProductName = new TextView(context);
		rowProductName.setText(product.getName());
		rowProductName.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
		addView(rowProductName);
		
		rowQuantity = new TextView(context);
		rowQuantity.setText(String.valueOf(quantity.getQuantity()));
		rowQuantity.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
		addView(rowQuantity);
	}
